...
class DiskPage(BasePage):
    ...
    def _assign_root(self, btn):
        ...
        if self.root_partition is not None:
            ...
            model.set_value(
                self.root_partition_row,
                INDEX_PARTITION_FORMAT_AS,
                self.root_format_saved)
            model.set_value(
                self.root_partition_row,
                INDEX_PARTITION_MOUNT_AS,
                self.root_mount_saved)
        ...
        self.root_format_saved = model[
            self.selected_row][INDEX_PARTITION_FORMAT_AS]
        self.root_mount_saved = model[
            self.selected_row][INDEX_PARTITION_MOUNT_AS]
    ...
    def _assign_swap(self, btn):
        ...
        self.swap_format_saved = model[
            self.selected_row][INDEX_PARTITION_FORMAT_AS]
        self.swap_mount_saved = model[
            self.selected_row][INDEX_PARTITION_MOUNT_AS]
